              ...
              <form onSubmit={handleSignIn} className="space-y-6 sm:space-y-8">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="remember-me" className="ml-2 sm:ml-3 block text-sm sm:text-base text-gray-700">
                      Remember me
                    </label>
                  </div>
            ...
            <div className="mt-8 sm:mt-10">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm sm:text-base">
                  <span className="px-3 sm:px-4 bg-white text-gray-500">New to our platform?</span>
                </div>
              </div>
